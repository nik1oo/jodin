...
EllipticPi:: proc(n, k: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_EllipticPi{ n=n, k=k }
	return expr }
...
expint:: proc(n, x: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_expint{ n=n, x=x }
	return expr }
...
ibeta:: proc(a, b, x: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_ibeta{ a=a, b=b, x=x }
	return expr }
...
igamma:: proc(a, z: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_igamma{ a=a, z=z }
	return expr }
...
invibeta:: proc(a, b, p: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_invibeta{ a=a, b=b, p=p }
	return expr }
...
invigamma:: proc(a, p: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_invigamma{ a=a, p=p }
	return expr }
...
LambertW:: proc(z, k: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_LambertW{ z=z, k=k }
	return expr }
...
SynchrotronF:: proc(x: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_SynchrotronF{ x=x }
	return expr }
...
uigamma:: proc(a, x: ^Expression) -> ^Expression {
	expr: ^Expression = new(Expression)
	expr^ = Expression_uigamma{ a=a, x=x }
	return expr }
